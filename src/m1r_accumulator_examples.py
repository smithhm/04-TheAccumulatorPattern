...
#            for _ in range(n):
#        What does the   _   (underscore) mean?  Its still a variable just its not used in the loop so the actual
#        value of it can be ignored.
#
...
#
#              x = starting_point.x                             This one is the correct one.
#              for k in range(n):
